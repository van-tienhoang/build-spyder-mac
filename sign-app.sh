...
#$ ln -s 3.6 Spyder3.app/Contents/Frameworks/Python.framework/Versions/Current
#$ codesign -s "mac developer" Spyder3.app/Contents/Frameworks/Python.framework/Versions/3.6/
#$ codesign -s "mac developer" Spyder3.app/Contents/MacOS/pip
#$ codesign -s "mac developer" Spyder3.app